...
- **3-Knob Surgery Sandbox:** Interactive HUD allowing users to independently manipulate Dimension ($D$), Sparsity ($p$), and Context Length ($T$) to observe live associative recall accuracy, cross-talk interference, and synaptic saturation curves.
...
#### Epilogue: The Sixty-Second Test
...
- [x] **Complete Submission Package (ZIP):** [`IITKgp_KVCache_Submission_Package.zip`](IITKgp_KVCache_Submission_Package.zip)
